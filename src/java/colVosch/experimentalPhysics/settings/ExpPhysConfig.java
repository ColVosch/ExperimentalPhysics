...
public class ExpPhysConfig
{
	...
	public static void init(File location)
	{
		...
		setCoolDownConstantIron(config.getFloat("coolDownConstantIron", Configuration.CATEGORY_GENERAL, 0.9f, 0.0f, 1.0f, StatCollector.translateToLocal("propperty.coolDownConstantIron.comment"), StatCollector.translateToLocal("propperty.coolDownConstantIron.display")));
		setCoolDownFactor(config.getFloat("coolDownFactor", Configuration.CATEGORY_GENERAL, 0.02f, 0.0f, 1.0f, StatCollector.translateToLocal("propperty.coolDownFactor.comment"), "propperty.coolDownFactor.display"));
