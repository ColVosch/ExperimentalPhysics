...
public class TileEntityRefiner extends TileEntityStoring implements ISynchronizable<PacketSyncRefiner>
{
	...
	public void synchronize(PacketSyncRefiner message)
	{
